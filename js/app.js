(() => {
    ...
    class SelectConstructor {
        ...
        getSelectTitleValue(selectItem, originalSelect) {
            ...
            if (originalSelect.hasAttribute("data-pseudo-label")) {
                pseudoAttribute = originalSelect.dataset.pseudoLabel ? ` data-pseudo-label="${originalSelect.dataset.pseudoLabel}"` : ` data-pseudo-label="Заполнить атрибут"`;
    ...
    function initSliders() {
        if (document.querySelector(".how-work__body")) new Swiper(".how-work__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".history__body")) new Swiper(".history__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".blog-detail__body")) new Swiper(".blog-detail__body", {
    ...
    function responsiveSwiper({selector, swiperParams, breakpoint = 991.98}) {
        let swiperInstance = null;
        function checkBreakpoint() {
            const container = document.querySelector(selector);
            if (!container) return;
            if (window.innerWidth <= breakpoint && !swiperInstance) swiperInstance = new Swiper(container, swiperParams); else if (window.innerWidth > breakpoint && swiperInstance) {
